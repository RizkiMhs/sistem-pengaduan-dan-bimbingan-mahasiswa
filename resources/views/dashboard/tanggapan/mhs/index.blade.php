 ...
 <div class="table">
    <table class="table table-hover">
        ...
        <tbody>
            ...
            @if ($item->pengaduan->mahasiswa->user_id == Auth::user()->id)
            <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <ul class="list-group">
                                <li class="list-group-item"><strong>NIM:</strong> {{ $item->pengaduan->mahasiswa->nim }}</li>
                                <li class="list-group-item"><strong>Nama:</strong> {{ $item->pengaduan->mahasiswa->nama }}</li>
